...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div id="breadcrumbs">
                <a class="animate_on_hover">Главная</a> /
                Регистрация
            </div>
        </div>
    </div>
    ...
    <div class="row" id="auth_row">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="auth_page_descr">Для более удобного и быстрого оформления заказов на нашем сайте Вам нужно
                создать аккаунт.
            </div>


            <sf:form method="post" action="registration" modelAttribute="userform">
                <sf:errors path="username"/>
                <sf:input type="text" path="username" class="form-control rd_input" placeholder="Имя пользователя"
                          value=""/>

                <sf:errors path="email"/>
                <sf:input type="email" path="email" class="form-control rd_input" name="email" placeholder="E-Mail"
                          value=""/>

                <sf:errors path="password"/>
                <sf:input type="password" path="password" class="form-control rd_input" name="password"
                          placeholder="Пароль"/>

                <sf:input type="password" path="repassword" class="form-control rd_input" name="password_confirmation"
                          placeholder="Пароль еще раз"/>
                <label class="rd_checkbox_label">
                    <input type="checkbox" name="agree"> Я прочитал(а) и принимаю <a target="_blank"
                                                                                     class="animate_on_hover underline"
                >Условия
                    использования</a>
                </label>
                <button type="submit" class="animate_on_hover_bg auth_button">Зарегистрироваться</button>
            </sf:form>
        </div>
